...
const BlogSidebar = () => {
  ...
  const popularPosts = [
    ...
    },
    {
      ...
      date: 'April 28, 2023',
      image:
        'https://images.unsplash.com/photo-1579403124614-197f69d8187b?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
    },
    {
      title: 'Building Scalable Microservices',
      date: 'March 10, 2023',
      image:
        'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
    },
  ];
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Learn how to set up a new project with Next.js and TypeScript for better developer experience and type safety.',
      date: 'June 5, 2023',
      author: 'Sarah Johnson',
      category: 'Web Development',
      readTime: '5 min read',
      image:
        'https://images.unsplash.com/photo-1626785774573-4b799315345d?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80',
    },
    {
      title: 'The Complete Guide to CSS Grid Layout',
      excerpt:
        'Master CSS Grid with this comprehensive guide covering all the properties and practical examples for modern layouts.',
      date: 'May 22, 2023',
      author: 'Michael Chen',
      category: 'Web Development',
      readTime: '8 min read',
    ...
    },
    {
      ...
      excerpt:
        'Essential techniques and tools to ensure your web applications are accessible to all users regardless of ability.',
      date: 'May 10, 2023',
      author: 'Emma Davis',
    ...
    },
    {
      ...
      excerpt:
        'Comparing different state management solutions for React and when to use each one in your projects.',
      date: 'April 28, 2023',
      author: 'David Wilson',
      category: 'Web Development',
      readTime: '7 min read',
      image:
        'https://images.unsplash.com/photo-1633356122544-f134324a6cee?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80',
    },
    {
      title: 'Mobile First Design Principles',
      excerpt:
        'Why mobile-first design matters and how to implement it effectively in your design workflow.',
      date: 'April 15, 2023',
      author: 'Jessica Lee',
      category: 'UI/UX Design',
      readTime: '4 min read',
      image:
        'https://images.unsplash.com/photo-1555774698-0b77e0d5fac6?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80',
    },
    {
      title: 'Optimizing React Performance',
      excerpt:
        'Practical tips and tricks to improve the performance of your React applications.',
      date: 'March 30, 2023',
      author: 'Robert Taylor',
      category: 'Web Development',
      readTime: '9 min read',
      image:
        'https://images.unsplash.com/photo-1579403124614-197f69d8187b?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80',
    },
  ];
